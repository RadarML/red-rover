...
Our dataset distribution also includes [GRT model](https://wiselabcmu.github.io/grt/) checkpoints pre-trained for each objective (3D occupancy, 2D occupancy, semantic segmentation, and ego-motion).

!!! tip

    See [our paper](https://arxiv.org/pdf/2509.12482?) for more details about the dataset. Make sure to download the arxiv version to see the attached (and linked) appendix!
